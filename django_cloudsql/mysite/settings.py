...
# to the instance
DATABASES['default']['HOST'] = '/cloudsql/climatechangecentral:us-central1:polls-instance'
...
STATIC_URL = 'https://storage.googleapis.com/climatechangecentralbucket/static/'
# [END staticurl]
